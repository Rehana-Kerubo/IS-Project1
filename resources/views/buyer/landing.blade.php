...
<!-- Navbar End -->
    ...
    @if(session('info'))
  <div class="fixed-top w-100 d-flex justify-content-center" style="z-index: 1050;margin-top: 80px;">
    <div class="alert alert-info alert-dismissible fade show shadow" style="max-width: 700px;" role="alert">
      {{ session('info') }}
...
@if(session('success'))
  <div class="fixed-top w-100 d-flex justify-content-center" style="z-index: 1050;margin-top: 80px;">
    <div class="alert alert-success alert-dismissible fade show shadow" style="max-width: 700px;" role="alert">
      {{ session('success') }}
      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
