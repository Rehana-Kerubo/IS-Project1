...
<nav class="navbar navbar-expand-lg bg-inverse fixed-top scrolling-navbar custom-gradient-navbar">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <form action="{{ url('/vendor/search') }}" method="GET" class="form-inline my-2 my-lg-0 mx-auto">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link" href="{{ url('/vendor/view-acc') }}">
      ...
      @foreach($results as $product)
        <div class="product-card">
          ...
          <form action="{{ route('vendor.checkout') }}" method="GET">
            ...
            <form method="POST" action="{{ route('vendor.bookProduct') }}">
    @csrf
